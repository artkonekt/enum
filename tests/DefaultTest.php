...
class DefaultTest extends TestCase
{
    ...
    {
        $this->assertEquals(Sample123::__default, Sample123::default());
        $this->assertEquals(SampleOneTwoThree::__default, SampleOneTwoThree::default());
    }
    ...
    {
        $this->assertNull(SampleFooBarNoDefault::default());
    }
    ...
    {
        $this->assertEquals(Sample1234::__default, Sample1234::default());
    }
    ...
    {
        $this->assertNull(NullableEnum::default());
    }
    ...
    {
        $this->assertEquals(Sample12345With5AsDefault::__default, Sample12345With5AsDefault::default());
        $this->assertEquals(Sample12345With5AsDefault::FIVE, Sample12345With5AsDefault::default());
        $this->assertEquals(5, Sample12345With5AsDefault::default());
    }
